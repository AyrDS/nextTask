   ...
   return (
      <>
         <div className='flex justify-between' >
            ...
            <button
               className='flex items-center gap-2 text-red-500 hover:bg-red-600 hover:text-white transition-colors p-2 rounded cursor-pointer'
            ...
            >
               ...
               <p className='uppercase font-bold '>Eliminar</p>
            </button>
         </div>
